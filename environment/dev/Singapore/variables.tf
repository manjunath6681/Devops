...
variable "secret_key" {}
# Network blocks
variable "vpc_cidr_block"         { default = "10.4.0.0/16"   }

variable "public_cidr_blocks"     { default = [ "10.4.0.0/24", "10.4.1.0/24" ]}
variable "private_cidr_blocks"    { default = [ "10.4.10.0/24", "10.4.11.0/24" ]}
variable  "rewards_primary_zone_id" { default = "ZKHY9DTXPSYXV" }
variable "VPN_Domain" { default = "Singapore_vpn"}
# VPC peering
variable "management_owner_id" { default = "530170256884" }
variable "management_vpc_id"   { default = "vpc-8a7feeee" }
variable "management_vpc_cidr" { default = "10.1.0.0/16" }
variable "management_route_table_id" {default = "rtb-53025a37" }
variable "management_public_sg" {default = "sg-83f592e4" }

# nat instance variables
variable "Rewards_nat_role" { default = "NAT"}
variable "Rewards_nat_instance_count" { default = 1 }
variable "nat_base_ami" { default = "ami-018c3062" }
...
variable "rewards_nat_keypair_name" { default = "non-prod-rewards-devops-singapore" }
...
variable "app_base_ami" { default = "ami-dc9339bf" }
variable "app_user" { default = "ec2-user" }
variable "app_package_manager" { default = "yum" }
variable "Rewards_app_instance_type" { default = "t2.small" }
variable "rewards_app_keypair_name" { default = "non-prod-rewards-devops-singapore" }
...
variable "db_base_ami" { default = "ami-dc9339bf" }
...
variable "rewards_db_keypair_name" { default = "non-prod-rewards-devops-singapore" }
